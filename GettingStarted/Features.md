...
| Option | Effet |
|--|--|
| **Show hidden objects** | Affiche l'emplacement et les minuteurs où sont placés les objets invisibles, tels que les ward, les boîtes de Shaco, les champignons Teemo, etc. |
| **Damage indicators** | Affiche les dégâts approximatifs que vous pouvez infliger à un ennemi avec votre combo. |
| **Enemy auto-attack range** | Affiche un cercle autour du champion ennemi qui représente sa zone d'auto attaque. |
| **Recall tracker** | Affiche un tracker qui apparaît lorsque le champion ennemi commence à retourner à la base.|
| **Minimap**: Minimap Hack |Affiche la dernière position d'un champion ennemi sur la carte. |
| **Minimap**: Glow on missing enemy | Affiche un modèle du champion ennemi transparent brillant sur son dernier emplacement connu. |
| **Minimap**: Minimap Circles | Affiche des cercles autour des icônes des ennemies manquants sur la carte représentant leur emplacement possible en fonction de leur vitesse de déplacement. |
| **Spell tracker**: Show spell LVL | Affiche les points sur le Spell tracker représentant le niveau du sort. |
| **Spell tracker**: Ally | Active le Spell tracker pour les champions alliés. |
...
| **Gank alert**: Only Enemy | Active le Gank alert pour les champions ennemis uniquement. |
| **Gank alert**: Only Junglers | Active le Gank alert pour les champions avec un Smite uniquement. |
| **Waypoints**: Show enemy click | Indique l'emplacement des clique de mouvement des champions ennemis. |
| **Waypoints**: Show ally click | Indique l'emplacement des clique de mouvement des champions alliés. |

### Nickname Changer

Si activé, vous permet de changer les surnoms pour les alliés et les ennemis.
**Note**: la désactivation de l'option après avoir changé un surnom ne rétablira pas la modification.

### Target Selector

| Option | Effet |
|--|--|
| **Enable selected target focus** | Vous permet de choisir la cible que vous souhaitez focaliser avec le bouton gauche de la souris. Mets la cible au-dessus de la liste des priorités. |
| **ONLY selected target** | Force l'Orbwalker à attaquer uniquement la cible sélectionnée, en ignorant les autres champions. |
| **Focus important buffs** | Forces l'Orbwalker à focaliser les champions qui portent des buffs rouges / bleus plutôt que les champions qui ne le font pas. |
| **Modes**: Auto | Choisit la cible en fonction de la combinaison des critères, elle ciblera également les cibles qui ont moins de 30% de points de vie.|
| **Modes**: Low HP | Focalise la cible avec le moins de points de vies. |
| **Modes**: Most AD | Focalise la cible avec le plus d'AD. |
| **Modes**: Most AP | Focalise la cible avec le plus d'AP. |
| **Modes**: Closest | Focalise la cible avec la plus proche. |
| **Modes**: Near Mouse | Focalise la cible avec la plus proche de la souris. |
